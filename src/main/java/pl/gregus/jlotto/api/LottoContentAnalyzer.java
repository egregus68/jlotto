 ...
 * @author Grzegorz
 */
public class LottoContentAnalyzer implements ContentAnalyzer {

    private static final Logger LOGGER = LoggerFactory.getLogger(LottoContentAnalyzer.class);
    ...
    public LottoContentAnalyzer(DrawType drawType, int resultNumber) {
        this.drawType = drawType;
        this.resultNumber = resultNumber;
        this.date = null;
    }

    public LottoContentAnalyzer(DrawType drawType, LocalDateTime date) {
        this.drawType = drawType;
